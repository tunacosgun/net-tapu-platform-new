...
export const pageTemplates: Record<string, ContentBlock[]> = {
  ...
  'withdrawal-rights': [
    ...
    { type: 'text', content: '<h2>1. Cayma Hakkı Nedir?</h2><p>6502 sayılı Tüketicinin Korunması Hakkında Kanun\'un 48. maddesi ve Mesafeli Sözleşmeler Yönetmeliği uyarınca, mesafeli sözleşmelerden doğan cayma hakkı, tüketicinin herhangi bir gerekçe göstermeksizin ve cezai şart ödemeksizin sözleşmeden dönme hakkıdır.</p><h3>1.1 Cayma Süresi</h3><p>Tüketici, hizmetin ifasına başlama tarihinden itibaren <strong>14 (on dört) gün</strong> içinde cayma hakkını kullanabilir. Cayma hakkı süresinin hesabında; sözleşmenin kurulduğu gün dahil edilir ve süre takip eden 14. günün sonunda sona erer.</p><h3>1.2 Cayma Hakkının Kullanımı</h3><p>Cayma hakkını kullanmak için aşağıdaki yöntemlerden birini tercih edebilirsiniz:</p><ul><li><strong>E-posta:</strong> cayma@nettapu.com adresine yazılı bildirim</li><li><strong>Platform Üzerinden:</strong> Hesabım &gt; Siparişlerim &gt; Cayma Talebi</li><li><strong>Posta:</strong> Firma adresine iadeli taahhütlü mektup</li></ul>' },
    { type: 'spacer', size: 'sm' },
    { type: 'text', content: '<h2>2. Cayma Hakkı Kapsamındaki İşlemler</h2><h3>2.1 Cayma Hakkının Geçerli Olduğu Durumlar</h3><ul><li>Platform üzerinden yapılan depozito (kaparo) ödemeleri</li><li>Danışmanlık hizmeti başvuruları</li><li>Premium üyelik işlemleri</li><li>Henüz ifa edilmemiş hizmet alımları</li></ul><h3>2.2 Cayma Hakkının Kullanılamayacağı Durumlar</h3><p>Aşağıdaki hallerde cayma hakkı kullanılamaz:</p><ul><li>Tamamlanan açık artırma işlemleri (ihale sonuçlanan ve tescil başlayan işlemler)</li><li>Tüketicinin onayıyla cayma hakkı süresi içinde ifa edilen hizmetler</li><li>Tüketiciye özel hazırlanan değerleme ve rapor hizmetleri</li><li>Fiyatı finansal piyasalardaki dalgalanmalara bağlı olarak değişen gayrimenkul alımları (Yönetmelik Madde 15/c)</li></ul>' },
    { type: 'spacer', size: 'sm' },
    { type: 'text', content: '<h2>3. İade Süreci</h2><h3>3.1 İade Başvurusu</h3><p>Cayma hakkının kullanılması halinde, cayma bildiriminin NetTapu\'ya ulaştığı tarihten itibaren en geç <strong>14 gün</strong> içinde ödeme iadesi gerçekleştirilir. İade, ödemenin yapıldığı ödeme yöntemine uygun olarak yapılır.</p><h3>3.2 İade Öncelikleri</h3><p>İade işlemlerinde; ödemenin yapıldığı kanal üzerinden iade yapılması esastır. Kredi kartı ile yapılan ödemelerde iade kredi kartına, banka havalesi ile yapılan ödemelerde belirtilen IBAN\'a aktarılır.</p>' },
    { type: 'table', headers: ['Ödeme Yöntemi', 'İade Süresi', 'Açıklama'], rows: [
      { cells: ['Kredi Kartı', '5-10 iş günü', 'Banka işlem sürelerine bağlı'] },
      { cells: ['Banka Karti (Debit)', '5-10 iş günü', 'Karta iade edilir'] },
      { cells: ['Banka Havalesi / EFT', '3-5 iş günü', 'IBAN bilgisi gereklidir'] },
      { cells: ['Sanal POS', '5-10 iş günü', 'Ödeme sağlayıcısına bağlı'] },
    ] },
    { type: 'spacer', size: 'sm' },
