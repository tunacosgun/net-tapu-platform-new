  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="space-y-4 rounded-xl border-2 border-gray-100 bg-gray-50/50 p-5">
          <div>
            <label className="flex items-start gap-3 text-sm text-gray-700 cursor-pointer">
              ...
              <span className="leading-relaxed">
                <Link href="/legal" target="_blank" className="text-green-600 hover:text-green-700 font-semibold transition-colors">
                  Kullanım Koşulları
                </Link>
                {' ve '}
                <Link href="/legal" target="_blank" className="text-green-600 hover:text-green-700 font-semibold transition-colors">
            ...
            {errors.acceptTerms && (
              <p className="mt-1 ml-7 text-xs text-red-500">{errors.acceptTerms.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.acceptKvkk && (
              <p className="mt-1 ml-7 text-xs text-red-500">{errors.acceptKvkk.message}</p>
            )}
          </div>
        </div>
